...
(This template has been __heavily__ copied from [Professor David Liu](https://www.cs.toronto.edu/~david/)).
...
- [ ] If this is my first contribution, I have added myself to the list of contributors in package.json.
- [ ] I have updated the project Changelog (this is required for all changes).
- [] I have rebased my changes and named my commits following [conventional commits](https://gist.github.com/qoomon/5dfcdf8eec66a051ecd85625518cfd13)

After opening your pull request:

- [ ] I have verified that the GitHub Actions checks have passed.
